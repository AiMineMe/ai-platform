    ...
    stats: {
        ...
        validator: (value) => {
            return value && typeof value === 'object' &&
                ...
                typeof value.inactiveGateways === 'number' &&
                typeof value.averageRate === 'number';
        }
    },
    filters: {
        type: Object,
...
const inactiveGatewaysCount = computed(() => props.stats?.inactiveGateways || 0);
const averageRateCount = computed(() => props.stats?.average_rate || 0);
...
const applyFilters = () => {
    ...
    router.get('/admin/withdrawal-gateways', params, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
        onFinish: () => {
...
const clearAllFilters = () => {
    ...
    router.get('/admin/withdrawal-gateways', {
        sort_field: 'name',
        sort_direction: 'asc'
    }, {
        preserveState: true,
...
const canUpdateStatus = (gateway) => {
    if (!isAdmin.value) return false;
    return true;
};

const updateGatewayStatus = async (gatewayId, newStatus) => {
    if (!isAdmin.value || updatingGateway.value === gatewayId) return;

    const gateway = props.gateways.find(g => g && g.id === gatewayId);
    if (!gateway || !canUpdateStatus(gateway)) {
    ...
    try {
        router.patch(`/admin/withdrawal-gateways/${gatewayId}/toggle-status`, {
            status: newStatus
        }, {
            preserveScroll: true,
            preserveState: true,
...
const createGateway = () => {
    router.get('/admin/withdrawal-gateways/create');
};

const editGateway = (gateway) => {
    router.get(`/admin/withdrawal-gateways/${gateway.id}/edit`);
};
...
const confirmDelete = () => {
    ...
    router.delete(`/admin/withdrawal-gateways/${selectedGateway.value.id}`, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
            closeDeleteModal();
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Manage withdrawal methods and configurations
                    </p>
                </div>
                        ...
                        >
                            <div class="text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                    No withdrawal gateways found
                                </h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    No withdrawal gateways match your current filters. Try adjusting the search
                                    criteria.
                                </p>
                            </div>
                        </td>
                    ...
                    <tr v-if="isLoading">
                        ...
                        >
                            <div class="flex items-center justify-center">
                                ...
                                <span class="text-gray-600 dark:text-gray-400">Loading withdrawal gateways...</span>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-3">
                                <div class="h-10 w-10 flex-shrink-0">
                                    <div
                                        class="h-full w-full rounded-lg bg-gradient-to-br from-red-500 to-pink-600 flex items-center justify-center text-white font-semibold text-sm shadow-md">
            ...
            >
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white text-center mb-2">
                        Delete Withdrawal Gateway
                    </h3>
                    <p class="text-gray-600 dark:text-gray-400 text-center text-sm mb-4">
                        Are you sure you want to delete this withdrawal gateway? This action cannot be undone.
                    </p>
                    ...
                    >
                        <div class="text-sm space-y-2">
                            ...
                            <div class="text-gray-600 dark:text-gray-400">
                                Rate: 1 {{ currencySymbol }} = {{ formatNumber(selectedGateway.rate) }}
